...
<?php 
 ...
 <form method="POST">
 <div><!-- Search Bar -->
 <div class="row" style="margin-top:5px; margin-left:135px; margin-right: 30px;">
  			...
  			<div class="card-deck">
  				<div class="card p-2 border-secondary mb-2">
  					...
  					<div class="card-body p-1">
  						  ...
  						  <h5 class="card-text text-center">Ksh.&nbsp;&nbsp;<?= number_format($row['hire_cost'],2) ?>/-</h5>
                            <button class="btn btn-info btn-block addItemBtn">Select this Car<a href="book_car.php?id=<?php echo $row['id']?>"></button>
  					</div>
  				</div>
  			</div>
  		</div>
